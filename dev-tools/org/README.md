...
🚀 [Finish setting up your workspace](https://cloud.nx.app/connect/d74gqFLrOe) to get faster builds with remote caching, distributed task execution, and self-healing CI. [Learn more about Nx Cloud](https://nx.dev/ci/intro/why-nx-cloud).
...
- [Vite](https://nx.dev/recipes/vite)
